...
class TransmissionVsGenetics(IAnalyzer):
    def __init__(self, save_figs=True):
        filenames = ["summary_statistics.csv", "coi.csv", "within_host_ibs.csv", "clone_data.csv", "within_host_ibd.csv"]
    ...
    def map(self, data, simulation):
        ...
        within_host_ibd_df = data[self.filenames[4]]
        ...
        mean_within_host_ibd = within_host_ibd_df["ibd"].mean()
        ...
        return_data = {"sim_id": str(simulation.id),
                       ...
                       "mean_within_host_ibd": mean_within_host_ibd,
    ...
    def reduce(self, all_data):
        ...
        plt.figure()
        plt.scatter(return_data["prev"], return_data["mean_within_host_ibd"])
        plt.xlabel("Prev")
        plt.ylabel("Mean within-host IBD")
        plt.savefig("within_host_ibd_sweep.png")

        return return_data


if __name__ == "__main__":
    # exp_id = "1cc12931-2667-ef11-aa17-9440c9be2c51"
    # exp_id = "5ef8e9e3-2767-ef11-aa17-9440c9be2c51"
    # exp_id = "651e73d9-2967-ef11-aa17-9440c9be2c51"
    exp_id = "9105fffe-2767-ef11-aa17-9440c9be2c51"
