...
# Step 1: Set parameters that will be swept over
daily_bite_rate_values = list(np.round(np.linspace(0.1,2,10),2))
...
def create_experiment_with_sif(platform):
    ...
    builder.add_sweep_definition(set_seed, range(4))
...
if __name__ == '__main__':
    platform = Platform("Calculon", num_cores=1, node_group="idm_48cores", priority="Normal")
